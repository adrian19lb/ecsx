...
def Settings( **kwargs ):
  if kwargs[ 'language' ] == 'cfamily':
    ...
    filename = GetIncludedTemplateDeclaration(base_filename)
    ...
    if not compilation_info.compiler_flags_:
        header_flag_maker = flag_appender.PrependedFlagGenerator("-I")
        generated_flag = header_flag_maker.generate(filename)
        flags.extend(generated_flag)
        return {
            'flags': flags
        }
